...
<template>
  <div class="homepage bg-gray-50 min-h-screen pb-8 sm:pb-12 font-sans flex flex-col items-center">
    <main class="w-full max-w-[1400px] px-0 mx-auto">
      ...
      <div v-else-if="hasError" class="py-16 flex flex-col items-center justify-center text-center">
        <div class="bg-white rounded-2xl shadow-sm border border-red-100 p-6 sm:p-10 max-w-md w-full">
      ...
      <section class="py-4 sm:py-8 [&_.slick-slide]:text-center [&_.slick-slide]:h-auto [&_.slick-slide]:leading-normal [&_.slick-slide]:overflow-hidden [&_.slick-slide_h3]:text-white">
        <a-carousel autoplay class="rounded-2xl overflow-hidden shadow-xl">
          <div v-for="article in latestHeadlines.slice(0, 5)" :key="article.id"
            ...
            <div
              class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-4 sm:p-8 md:p-12">
      ...
      <section class="mb-10 sm:mb-16 px-2 py-3 sm:px-4 sm:py-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <RouterLink to="/news"
            class="bg-white p-4 sm:p-6 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group text-center flex flex-col items-center no-underline">
            <div
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 mb-10 sm:mb-16">
        ...
        <section class="lg:col-span-2 px-2 py-3 sm:px-4 sm:py-4">
          <div class="flex items-center justify-between mb-4 sm:mb-6 px-1 sm:px-2">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-2 sm:p-4">
            ...
            <ul v-else class="divide-y divide-gray-100">
              <li v-for="headline in latestHeadlines" :key="headline.id" class="group">
                <RouterLink :to="{ name: 'articleDetails', params: { id: headline.id } }"
                  class="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-gray-50 transition-colors duration-200">
      ...
      <div class="space-y-10 sm:space-y-16">
        ...
        <!-- Gallery -->
        <section class="px-2 py-3 sm:px-4 sm:py-4">
          <div class="flex items-center justify-between mb-5 sm:mb-8 px-1 sm:px-2">
