...
<template>
  <div class="homepage bg-gray-50 min-h-screen pb-12 font-sans">
    <main class="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
      
      <!-- Hero Section -->
      <section class="py-8">
        <a-carousel autoplay class="rounded-2xl overflow-hidden shadow-xl">
          <div v-for="article in featuredArticles.slice(0, 4)" :key="article.id" class="relative h-[500px] md:h-[600px] w-full">
      ...
      <section class="mb-16">
        <div class="flex items-center mb-6">
           <h2 class="text-2xl font-bold text-gray-800 border-l-4 border-blue-600 pl-4">លក្ខណៈពិសេស</h2>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Card 1 -->
            <div class="bg-white p-6 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                <div class="h-14 w-14 bg-blue-50 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-500 transition-colors duration-300">
             ...
             <!-- Card 2 -->
            <div class="bg-white p-6 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                <div class="h-14 w-14 bg-indigo-50 rounded-full flex items-center justify-center mb-4 group-hover:bg-indigo-500 transition-colors duration-300">
             ...
             <!-- Card 3 -->
            <div class="bg-white p-6 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                <div class="h-14 w-14 bg-amber-50 rounded-full flex items-center justify-center mb-4 group-hover:bg-amber-500 transition-colors duration-300">
             ...
             <!-- Card 4 -->
            <div class="bg-white p-6 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer group">
                <div class="h-14 w-14 bg-emerald-50 rounded-full flex items-center justify-center mb-4 group-hover:bg-emerald-500 transition-colors duration-300">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        ...
        <section class="lg:col-span-2">
          <div class="flex items-center justify-between mb-6">
            ...
            <RouterLink to="/news" class="text-blue-600 hover:text-blue-800 font-medium flex items-center text-sm">
                មើលទាំងអស់ <ArrowRightOutlined class="ml-1 text-xs" />
            </RouterLink>
          </div>
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <ul class="divide-y divide-gray-100">
                ...
                <RouterLink :to="{ name: 'articleDetails', params: { id: headline.id } }"
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-semibold text-gray-800 group-hover:text-blue-600 transition-colors mb-1 line-clamp-2">{{ headline.title }}</h4>
        ...
        <aside class="lg:col-span-1">
           <div class="sticky top-6">
              ...
              <div class="mt-6 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-6 text-white text-center shadow-lg">
                  ...
                  <button class="bg-white text-blue-600 px-4 py-2 rounded-lg font-bold text-sm hover:bg-blue-50 transition-colors w-full">Subscribe Now</button>
              </div>
           </div>
        </aside>
      </div>
      ...
      <div class="space-y-16">
        ...
        <section>
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800 border-l-4 border-amber-500 pl-4">សន្តសន្តី</h2>
                <RouterLink :to="{ name: 'saintList' }" class="text-amber-600 hover:text-amber-800 font-medium flex items-center text-sm">
                    មើលបន្ថែម <ArrowRightOutlined class="ml-1 text-xs" />
                </RouterLink>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <section>
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-800 border-l-4 border-indigo-500 pl-4">អត្ថបទព្រះគម្ពីរប្រចាំថ្ងៃ</h2>
                    <RouterLink :to="{ name: 'dailyBibleList' }" class="text-indigo-600 hover:text-indigo-800 font-medium flex items-center text-sm">
                        មើលបន្ថែម <ArrowRightOutlined class="ml-1 text-xs" />
                    </RouterLink>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <section>
                <div class="flex items-center justify-between mb-6">
                    ...
                    <RouterLink :to="{ name: 'dailySermonList' }" class="text-purple-600 hover:text-purple-800 font-medium flex items-center text-sm">
                        មើលបន្ថែម <ArrowRightOutlined class="ml-1 text-xs" />
                    </RouterLink>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <section>
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800 border-l-4 border-emerald-500 pl-4">កម្រងរូបភាព</h2>
                <RouterLink :to="{ name: 'galleryGridView' }" class="text-emerald-600 hover:text-emerald-800 font-medium flex items-center text-sm">
                    មើលបន្ថែម <ArrowRightOutlined class="ml-1 text-xs" />
                </RouterLink>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
