  ...
  try {
    ...
    if (id) {
      ...
      if (response.data) {
        ...
        // Fetch sibling chapters for navigation
...
// Watch for route changes to reload data when navigating via sidebar
  ...
  <div class="min-h-screen bg-gray-50 py-12">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        >
          <svg class="mr-2 h-5 w-5 transition-transform group-hover:-translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
          </svg>
          <span v-if="chapter?.bible?.name">Back to {{ chapter.bible.name }}</span>
        ...
        <div class="lg:col-span-3 order-1 lg:order-2 bg-white overflow-hidden shadow-sm rounded-lg">
          <div class="p-8">
            ...
            <div v-if="verses && verses.length > 0" class="mt-10 border-t border-gray-100 pt-6">
              <h3 class="text-xl font-semibold text-gray-900 mb-4">Verses</h3>
            ...
            <!-- Media Links -->
            <div v-if="(chapter.audio_url && chapter.audio_url !== 'string') || (chapter.video_url && chapter.video_url !== 'string')" class="mt-10 border-t border-gray-100 pt-6">
              <h3 class="text-lg font-medium text-gray-900 mb-4">Media Resources</h3>
