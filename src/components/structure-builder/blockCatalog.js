...
export const blockCatalog = [
  ...
  },
  {
    type: 'card-grid',
    label: 'Card Grid',
    description: 'Archive-style menu cards with icon, title, and open link',
    icon: '▦',
    category: 'content',
    defaults: {
      title: 'ស្វែងយល់បណ្ណសារ',
      subtitle: 'ផ្លាស់ពីរឿងរ៉ាវទៅការអធិស្ឋាន — តាមល្បឿនផ្ទាល់ខ្លួនរបស់អ្នក។',
      columns: 4,
      cards: [
        {
          title: 'ជីវប្រវត្តិ',
          description: 'រឿងរ៉ាវច្បាស់លាស់អំពីជីវិត ជំនឿ និងការបម្រើ។',
          icon: '✝',
          image: '',
          link: '',
          linkLabel: 'បើក',
        ...
        {
          title: 'សម្រង់ពាក្យ',
          description: 'ពាក្យសម្តីអំពីជំនឿ ភាពបរិសុទ្ធ និងជីវិតគ្រីស្ទាន។',
          icon: '✦',
          image: '',
          link: '',
          linkLabel: 'បើក',
        ...
        {
          title: 'អព្ភូតហេតុ',
          description: 'ស្វែងយល់រឿងរ៉ាវអព្ភូតហេតុដែលភ្ជាប់នឹងជំនឿ។',
          icon: '❖',
          image: '',
          link: '',
          linkLabel: 'បើក',
        ...
        {
          title: 'បណ្ណាល័យ',
          description: 'ទំព័រត្រៀមសម្រាប់ការអានស្ងប់ស្ងាត់។',
          icon: '☰',
          image: '',
          link: '',
          linkLabel: 'បើក',
